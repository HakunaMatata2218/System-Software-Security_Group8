...
gitCloneURLS = os.path.join(currentPath, "github_repos_java")  # Path to the file containing Git repository URLs
clonePath = os.path.join(currentPath, "repo_src")  # Path where repositories will be cloned
...
def clone_repositories():
    """Clone multiple repositories from a list of Git URLs"""
    try:
